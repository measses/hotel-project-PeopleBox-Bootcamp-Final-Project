...
const TasksList = () => {
  return (
    <div className="max-w-lg mx-auto my-10">
      <div>
        <h1 className="text-3xl font-medium mb-6">Görev Listesi</h1>
      </div>
      <div className="flex flex-row justify-between items-center">
        <div className="inline-flex space-x-2 items-center">
          ...
          >
            ...
            <span className="text-sm font-medium hidden md:block">Acil</span>
          </a>
          <a
            href="#"
          ...
          >
            ...
            <span className="text-sm hidden md:block">Son Eklenen</span>
          </a>
        </div>
      </div>
